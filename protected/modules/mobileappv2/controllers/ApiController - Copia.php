	...
	public function actionpayNow()
	{
    	...
    	if($res=mobileWrapper::getCart($this->device_uiid)){
		    ...
		    if ($code==1){
				...
				if($this->data["shedule_order"]=='1'){
								$params["shedule_order"] .=$this->data["shedule_order"];
								$params["mo"] .=$this->data["mo"];
								$params["tu"] .=$this->data["tu"];
								$params["we"] .=$this->data["we"];
								$params["th"] .=$this->data["th"];
								$params["fr"] .=$this->data["fr"];
								$params["sa"] .=$this->data["sa"];
								$params["su"] .=$this->data["su"];
								$params["shedule_type"] .=$this->data["shedule_type"];
								$params["days_start_date"] .=$this->data["days_start_date"];
								$params["days_end_date"] .=$this->data["days_end_date"];
